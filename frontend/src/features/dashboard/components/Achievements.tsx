...
export function Achievements({
    ...
    const totalCount =
        achievements.length;
    const recentAchievements = achievements.filter((achievement) => achievement.completed).slice(-3).reverse();
                            ...
                            (achievement) => {
                                ...
                                return (
                                    <div
                                        ...
                                        title={achievement.completed ? `${achievement.title} unlocked` : achievement.description}
                                    ...
                                    >
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div
                                                ...
                                                `}
                                            >
                                                <BadgeIcon title={achievement.title} icon={achievement.icon} className="h-4 w-4" />
                                            </div>
