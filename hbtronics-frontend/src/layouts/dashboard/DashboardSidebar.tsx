...
function NavigationSection({
    ...
    return (
        <div className="mt-6 first:mt-0">
            {!collapsed && (
                <p className="mb-2 px-3 text-[9px] font-bold uppercase tracking-[0.16em] text-[#3A3A3A]/30">
                    {title}
                </p>
            )}
        ...
        <>
            ...
            <aside
                className={`
                    ...
                    border-[#3A3A3A]/8
                    bg-white
                    shadow-[8px_0_30px_rgba(58,58,58,0.04)]
                    transition-all
                    duration-300
                ...
                >
                    {!collapsed && (
                        <div className="flex items-center gap-2.5">
                            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#F47822]">
                            ...
                            <div>
                                <p className="text-sm font-bold leading-none text-[#3A3A3A]">
                                    HBT
                                </p>

                                <p className="mt-0.5 text-[8px] font-semibold uppercase tracking-[0.16em] text-[#3A3A3A]/35">
                                    Learning
                                </p>
                            </div>
                        </div>
